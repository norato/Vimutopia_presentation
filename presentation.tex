...
\begin{frame}
    \frametitle{VI}
    \begin{center}
       \framebox{\includegraphics[width=1in]{img/vi.eps}}
    \end{center}
\end{frame}
...
\begin{frame}
    \begin{center}
       \framebox{\includegraphics[width=2in]{img/vim.eps}}
    \end{center}
\end{frame}
...
\begin{frame}
    ...
    \begin{center}
       \framebox{\includegraphics[width=2in]{img/install.eps}}
    \end{center}
\end{frame}
...
\begin{frame}
    ...
    \begin{center}
       \framebox{\includegraphics[width=2in]{img/rocks.eps}}
    \end{center}
\end{frame}
\subsection{Python}
...
\begin{frame}
    ...
    \begin{center}
       \framebox{\includegraphics[width=2in]{img/yeah.eps}}
    \end{center}
\end{frame}
...
\begin{frame}
    ...
    \begin{center}
       \framebox{\includegraphics[width=3in]{img/code.eps}}
    \end{center}
\end{frame} 
...
\begin{frame}
    ...
    \begin{center}
      \framebox{\includegraphics[width=3in]{img/perguntas.eps}}
    \end{center}
\end{frame}
